...
class BasketTest {
  ...
  static Stream<Arguments> basketProvidesTotalValue() {
    return Stream.of(noItems(), aSingleItemPricedPerUnit(), multipleItemsPricedPerUnit(), aSingleItemPricedByWeight(),
  ...
  private static Item<ItemByUnit> aPintOfMilk() {
    return new UnitProduct(new BigDecimal("0.49")).oneOf();
  }

  private static Item<ItemByUnit> aPackOfDigestives() {
  ...
  private static Item<ItemByWeight> twoFiftyGramsOfAmericanSweets() {
  ...
  private static Item<ItemByWeight> twoHundredGramsOfPickAndMix() {
